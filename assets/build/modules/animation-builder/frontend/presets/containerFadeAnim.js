...
/* harmony export */   containerFadeAnimation: function() { return /* binding */ containerFadeAnimation; }
/* harmony export */ });
function containerFadeAnimation() {
  ...
  function handleSetConfigAnimation({
    config = {},
    target = ""
  }) {
    if (!target) {
  ...
  function handleCleanUpTweens(target, activeTweens) {
    if (typeof activeTweens !== "object" || !target) {
      console.error("Container Fade Animation: Animation cleanup not working or target not found!");
    }
  ...
  function handleHoverAnimation(id = "", config = {}, itemClass = "", triggerClass = "", activeTweens = {}) {
    if (!triggerClass) {
  ...
  function handleClickAnimation(id = "", config = {}, itemClass = "", triggerClass = "", activeTweens = {}) {
    if (!triggerClass) {
      console.error("Container Fade Animation: Trigger class not found!");
      return;
    }
    ...
    sections.forEach(sections => {
      ...
      switch (triggerType) {
        ...
        case "play_with_scroll":
          ...
          break;
        case "hover":
          handleHoverAnimation(id, config, itemClass, triggerClass, activeTweens);
          break;
        case "click":
          handleClickAnimation(id, config, itemClass, triggerClass, activeTweens);
          break;
        default:
          break;
      }
