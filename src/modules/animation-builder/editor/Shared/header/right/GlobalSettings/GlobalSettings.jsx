...
const tabs = [
  ...
  { key: "global_value", label: "Global Value" },
...
const GlobalSettingModal = () => {
  return (
    ...
    >
      {/* Sidebar */}
      <TabsList
        className="h-full min-w-[179px] max-w-[179px] flex flex-col justify-start items-start gap-[3px] p-[15px] bg-transparent rounded-none"
