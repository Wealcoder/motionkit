...
const ContainerFadePreset = ({ contentStep, updateContentData }) => {
  ...
  return (
    <div className="flex flex-col gap-2 border-b border-border-2 w-full p-3">
      ...
      <div className="grid grid-cols-2 gap-2 justify-between items-center">
        <div className="flex items-center gap-1">
          <h3 className="text-xs text-text-2 capitalize">Fade From</h3>
          <ToolTipWrapper text={"Select fading direction"} />
        </div>
        <div className="flex items-center gap-1.5">
          <div className="flex-1">
            <Select
      ...
      <div className="grid grid-cols-2 gap-2 justify-between items-center">
        <div className="flex items-center gap-1">
          <h3 className="text-xs text-text-2 capitalize">Fade offset</h3>
          <ToolTipWrapper text={"Add the class name of the video element"} />
        </div>
        <div className="flex items-center gap-1.5">
          <div className="flex-1">
...
export default ContainerFadePreset;
