...
const TextSplitPrest = ({ contentStep, updateContentData }) => {
  ...
  return (
    <div className="flex flex-col gap-2 border-b border-border-2 w-full p-3">
      ...
      <div className="grid grid-cols-2 gap-2 justify-between items-center">
        <div className="flex items-center gap-1">
          <h3 className="text-xs text-text-2 capitalize">Split Type</h3>
          <ToolTipWrapper text={"Select the split type"} />
        </div>
        <div className="flex items-center gap-1.5">
          <div className="flex-1">
            <Select
      ...
      <div className="grid grid-cols-2 gap-2 justify-between items-center">
        <div className="flex items-center gap-1">
          <h3 className="text-xs text-text-2 capitalize">Transform X</h3>
          <ToolTipWrapper text={"Transform X value"} />
        </div>
        <div className="flex items-center gap-1.5">
          <div className="flex-1">
            <Input
      ...
      <div className="grid grid-cols-2 gap-2 justify-between items-center">
        <div className="flex items-center gap-1">
          <h3 className="text-xs text-text-2 capitalize">Transform Y</h3>
          <ToolTipWrapper text={"Transform Y value"} />
        </div>
        <div className="flex items-center gap-1.5">
          <div className="flex-1">
            <Input
