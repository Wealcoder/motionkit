        ...
        {saved.map((item) => (
          ...
          >
            ...
            <div className="flex items-center gap-[15px]">
              <Button className="min-w-11 max-h-6 border-none bg-button text-[#FAFAFA] text-[11.5px] font-normal leading-4.5 px-1.5 py-[3px] cursor-pointer">
                Insert
              </Button>
...
export default SavedAnimationContent;
